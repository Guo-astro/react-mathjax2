...
const MathJaxBaseContextProvider: FC<MathJaxBaseContextProps> = ({
  ...
  if (
    ...
    existingContext.promise === defaultContextValue.promise
  ) {
    throw Error(
    ...
    if (version === 2) {
      if (typeof v2Promise === "undefined") {
        if (typeof window !== "undefined") {
          ...
          v2Promise = Promise.reject(new Error("No window object"));
      ...
      if (typeof v3Promise === "undefined") {
        if (typeof window !== "undefined") {
          ...
          v3Promise = Promise.reject(new Error("No window object"));
